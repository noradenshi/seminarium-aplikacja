...
\author{Bar Dawid, Dobranowski Bartłomiej, Piotr Prezydent}
\shortauthor{D. Bar, B. Dobranowski, P. Prezydent}
\noAlbum{12345,12345,12345}

\titlePL{Przykładowa praca inżynierska wykonana na seminarium}
\titleEN{}

\shorttitlePL{Przykładowa praca inżynierska wykonana na seminarium} % skrócona wersja tytułu jeśli jest bardzo długi
\shorttitleEN{}
...
\supervisor{dr Krzysztof Balicki}
