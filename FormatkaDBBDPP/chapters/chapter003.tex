...
\begin{enumerate}
    ...
    \item Możliwość resetowania losowania
        Przydatną funkcją byłoby dodanie opcji przywrócenia list zadań do stanu początkowego. Pozwoliłoby to używać narzędzia wielokrotnie w ramach różnych grup studentów.
    ...
    \item Integracja z platformami e-learningowymi
        Aplikacja mogłaby zostać rozszerzona o integrację z systemami takimi jak Moodle, co pozwoliłoby na automatyczne przydzielanie zadań studentom w środowisku zdalnym.
